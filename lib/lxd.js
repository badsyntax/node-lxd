...
LXD.prototype.renameImage = bluebird.method(function(fingerprint, json) {
  console.log('RENAME IMAGE', fingerprint);
  return this._options.client.request({
    method: 'POST',
    url: this._genUri('1.0/images/' + fingerprint),
    json: json
...
LXD.prototype.getImageAliases = bluebird.method(function() {
  return this._options.client.request({
    method: 'GET',
    url: this._genUri('1.0/images/aliases'),
    json: true
  }).spread(function(res, body) {
    return body;
  });
...
LXD.prototype.createImageAlias = bluebird.method(function(json) {
  return this._options.client.request({
    method: 'POST',
    url: this._genUri('1.0/images/aliases'),
    json: json
